  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'marketing/ad-positions',      name: 'marketing-ad-positions', component: () => import('@/views/marketing/AdPositionListView.vue'),  meta: { title: '广告位置',  perm: 'ad' } },
        { path: 'marketing/ads',               name: 'marketing-ads',          component: () => import('@/views/marketing/AdListView.vue'),           meta: { title: '广告管理',  perm: 'ad' } },
        { path: 'marketing/ads/new',           name: 'marketing-ad-new',       component: () => import('@/views/marketing/AdFormView.vue'),           meta: { title: '新增广告',  perm: 'ad' } },
        { path: 'marketing/ads/:id/edit',      name: 'marketing-ad-edit',      component: () => import('@/views/marketing/AdFormView.vue'),           meta: { title: '编辑广告',  perm: 'ad' } },
